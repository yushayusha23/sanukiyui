            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
              {notes.map(note => {
                ...
                return (
                  <div
                    key={note.id}
                    className={`relative flex flex-col ${cs.bg} ${cs.border} border rounded-lg p-3 shadow-sm`}
                  ...
                  >
                    ...
                    <p className={`text-xs ${cs.text} whitespace-pre-wrap pr-4 leading-relaxed flex-1`}>
                      {note.content}
                    </p>
